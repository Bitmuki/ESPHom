  ...
  namespace hempy
  {
    ...
    */
    ...
    private:
      ...
      uint32_t PumpOnTimer = 0;             // Track how long watering pump is on continuosly (one water-drain cycle)
      ...
      float DrainTarget = 0.1;              // kg - How much water should drain into the waste reservoir before considering the watering cycle finished
    };
